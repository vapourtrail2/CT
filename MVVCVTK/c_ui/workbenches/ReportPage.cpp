...
#include "c_ui/workbenches/common/IconMaps/ReportIconMap.h"
...
static QIcon loadIconFor(const QString& text) {
    return RibbonCommon::loadIconByText(text, IconMaps11::kReportIconMap);
}
